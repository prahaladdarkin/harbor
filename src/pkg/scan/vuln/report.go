...
type VulnerabilityItem struct {
	...
	VendorAttributes []VendorAttribute `json:"vendor_attributes"`
}

// VendorAttribute represents a single arbitrary vendor specific attribute
type VendorAttribute struct {

	// An arbitrary property value that is exposed by the scanner
	// e.g. ScannerPropertyFoo
	Key string `json:"key"`

	// The value corresponding to the arbitrary property exposed by the scanner
	// e.g. ScannerPropertyValueBar
